		...
		<div id="page-header-content">
			<div id="page-header-content-left">
				...
				<div id="nav-happenings-menu" class="nav-menu">
					<ul>
					<?
						$menu_links_query = "SELECT l.link_title, l.link_path, (SELECT a.alias FROM drupal_url_alias as a WHERE a.source = l.link_path) AS path FROM drupal_menu_links AS l WHERE plid = '352' ORDER BY weight";
						$menu_links_result = mysql_query($menu_links_query, $connection);
						while ($menu_links_row = mysql_fetch_array($menu_links_result)) {
							echo "<li>";
							echo "<a href=\"/".$menu_links_row['path']."\">".$menu_links_row['link_title']."</a>";
		...
		<div id="page-footer-content">
			<div id="page-footer-content-top">
				<div id="page-footer-content-top-nav">
					<img src="/sites/all/themes/antonellis/images/antonellis_layout_static_22.png" class="first" /> <a target="_blank" href="http://maps.google.com/maps/ms?hl=en&ie=UTF8&msa=0&ll=30.304484,-97.7265&spn=0.002691,0.004361&z=18&msid=107182381059191692630.00047bd64f63b0f4689d7">4220 Duval St, Austin, TX 78751</a> &nbsp;
					...
					<img src="/sites/all/themes/antonellis/images/antonellis_layout_static_29.png" /> Tues-Sat 11-7  
					<img src="/sites/all/themes/antonellis/images/antonellis_layout_static_31.png" /> Sun 12-5 
					<img src="/sites/all/themes/antonellis/images/antonellis_layout_static_31.png" /> Closed Mon
				</div>
			</div>
...
<div id="footer">
	...
	<div id="footer-copy">&copy;<?=date('Y');?> Antonelli's Cheese Shop. All Rights Reserved.  |  Site by <a target="_blank" href="http://www.zocalodesign.com">Zocalo Design</a></div>
</div>
